...
-- Data input settings
cmd:option('-input_h5','my_train/oh5.h5','path to the h5file containing the preprocessed dataset')
cmd:option('-input_json','my_train/oj.json','path to the json file containing additional info and vocab')
...
-- Model settings
--512 earlier for both
cmd:option('-rnn_size',10,'size of the rnn in number of hidden nodes in each layer')
cmd:option('-input_encoding_size',20,'the encoding size of each token in the vocabulary, and the image.')
...
-- 2500 earlier
cmd:option('-save_checkpoint_every', 20, 'how often to save a model checkpoint?')
cmd:option('-checkpoint_path', 'my_checkpoints/', 'folder to save checkpoints into (empty = this folder)')
